...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                " pt-16  relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full z-0",
                className
            )}
        >
            ...
            <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5 mt-8">
                {children}
            </div>
        </div>
    );
